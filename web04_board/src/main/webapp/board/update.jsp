                ...
                <table align="center">
                    <tr>
                        <td>
                            ...
                            <label for="writer">작성자 ID</label> <input type="text" name="writer" id="writer" value="${vo2.writer}"><br>
                            <label for="wdate">작성날짜<input type="text" name="wdate" id="wdate"value="${vo2.wdate}"></label><br>
